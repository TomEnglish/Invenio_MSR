...
SITE_LATITUDE = 35.293    # Update with your project site coordinates
SITE_LONGITUDE = -101.603  # Update with your project site coordinates
...
class SamsaraSyncService:
    ...
    def __init__(self):
        ...
        self.supabase_url = os.getenv('SUPABASE_URL') or 'https://YOUR_PROJECT_ID.supabase.co'
