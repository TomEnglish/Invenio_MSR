...
CREATE TABLE samsara_trackers (
    ...
    distance_from_site_km NUMERIC(10, 2),    -- Distance from project site
...
CREATE OR REPLACE FUNCTION calculate_distance_from_site(
    tracker_lat NUMERIC,
    tracker_lon NUMERIC,
    site_lat NUMERIC DEFAULT 35.293,  -- Update with your project site coordinates
    site_lon NUMERIC DEFAULT -101.603  -- Update with your project site coordinates
)
RETURNS NUMERIC AS $$
DECLARE
