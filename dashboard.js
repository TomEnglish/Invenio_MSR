...
async function loadAllData() {
    try {
        ...
        const metrics = {
            ...
            status_counts: metricsData.status_counts || { po_status: {}, shipment_status: {} }
        };
            ...
            datasets: [
                {
                    label: 'Total Items',
                    data: items,
                    backgroundColor: '#8dc63f',  // RPS lime green
                    borderRadius: 8,
                    yAxisID: 'y'
                },
                {
                    label: 'Field Hours',
                    data: hours,
                    backgroundColor: '#3a3a3a',  // Charcoal
                    borderRadius: 8,
                    yAxisID: 'y1'
                }
            ]
